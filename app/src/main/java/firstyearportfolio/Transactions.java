...
// Laboratorio # 9
// Christian Sanchez Martinez
//
// Simulador de ATM
// Este programa crea una simulación de una máquina ATM. El programa presenta un
// menú de opciones para que el usuario escoja la operación que desea realizar. Estas
// opciones son:
//	a. hacer un depósito
//	b. hacer un retiro
//	c. verificar el balance de la cuenta
// Si se desea hacer un retiro, hay otro menú para retirar $10, $20, $50, $100 u otra
// cantidad; en este último caso, hay que pedir al usuario que escriba la cantidad a retirar
// en múltiplos de $10.
// El programa comienza presumiendo que el usuario tiene un balance de $500 en 
// su cuenta.
// Un depósito se lleva a cabo pidiendo al usuario la cantidad a depositar para 
// luego sumar esa cantidad al balance.
// Un retiro se lleva a cabo restando del balance la cantidad indicada.
// Una verificación de balance se lleva a cabo mostrando el balance al usuario
import java.util.*;

public class Transactions {
    public static void main(String[] args) {
        // double cantidadRetiro, cantidadDeposito;
        // Linea no se utilizó
